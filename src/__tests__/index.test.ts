...
describe("index (extension entry point)", () => {
	...
	describe("getManager()", () => {
		it("throws when called before session_start", async () => {
			...
			const getManager = (createStartProcessTool as MockedFunction<any>).mock.calls[0][0] as () => ProcessManager;
