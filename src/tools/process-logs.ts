  ...
  return {
    ...
    execute(_toolCallId, params, _signal, _onUpdate, _ctx) {
      ...
      if (params.tail !== undefined) {
        queryOptions.tail = params.tail;
      }
      if (params.start !== undefined) {
        queryOptions.start = params.start;
      }
      if (params.end !== undefined) {
        queryOptions.end = params.end;
      }
      if (params.grep) {
        queryOptions.grep = params.grep;
      }
      if (params.grepLiteral) {
        queryOptions.grepLiteral = params.grepLiteral;
      }
